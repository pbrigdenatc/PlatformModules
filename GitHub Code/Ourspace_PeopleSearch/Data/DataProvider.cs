...
namespace DotNetNuke.Modules.Ourspace_PeopleSearch.Data
{
    ...
    public abstract class DataProvider
    {
        ...
        public static DataProvider Instance()
        {
            if (provider == null)
            {
                const string assembly = "DotNetNuke.Modules.Ourspace_PeopleSearch.Data.SqlDataprovider,Ourspace_PeopleSearch";
