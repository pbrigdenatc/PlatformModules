...
namespace DotNetNuke.Modules.Ourspace_MiniProfile.Data
{
    ...
    public abstract class DataProvider
    {
        ...
        public static DataProvider Instance()
        {
            if (provider == null)
            {
                const string assembly = "DotNetNuke.Modules.Ourspace_MiniProfile.Data.SqlDataprovider,Ourspace_MiniProfile";
