...
namespace DotNetNuke.Modules.Ourspace_AttachmentComponent.Data
{
    ...
    public abstract class DataProvider
    {
        ...
        public static DataProvider Instance()
        {
            if (provider == null)
            {
                const string assembly = "DotNetNuke.Modules.Ourspace_AttachmentComponent.Data.SqlDataprovider,Ourspace_AttachmentComponent";
