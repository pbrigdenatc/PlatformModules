...
namespace DotNetNuke.Modules.Ourspace_Phase1ThreadInfo.Data
{
    ...
    public abstract class DataProvider
    {
        ...
        public static DataProvider Instance()
        {
            if (provider == null)
            {
                const string assembly = "DotNetNuke.Modules.Ourspace_Phase1ThreadInfo.Data.SqlDataprovider,Ourspace_Phase1ThreadInfo";
