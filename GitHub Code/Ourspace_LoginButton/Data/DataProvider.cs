...
namespace DotNetNuke.Modules.Ourspace_LoginButton.Data
{
    ...
    public abstract class DataProvider
    {
        ...
        public static DataProvider Instance()
        {
            if (provider == null)
            {
                const string assembly = "DotNetNuke.Modules.Ourspace_LoginButton.Data.SqlDataprovider,Ourspace_LoginButton";
