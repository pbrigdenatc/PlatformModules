...
namespace DotNetNuke.Modules.Ourspace_Microprofile.Data
{
    ...
    public abstract class DataProvider
    {
        ...
        public static DataProvider Instance()
        {
            if (provider == null)
            {
                const string assembly = "DotNetNuke.Modules.Ourspace_Microprofile.Data.SqlDataprovider,Ourspace_Microprofile";
