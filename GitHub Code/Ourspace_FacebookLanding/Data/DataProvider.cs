...
namespace DotNetNuke.Modules.Ourspace_FacebookLanding.Data
{
    ...
    public abstract class DataProvider
    {
        ...
        public static DataProvider Instance()
        {
            if (provider == null)
            {
                const string assembly = "DotNetNuke.Modules.Ourspace_FacebookLanding.Data.SqlDataprovider,Ourspace_FacebookLanding";
