...
namespace DotNetNuke.Modules.Ourspace_Utilities.Data
{
    ...
    public abstract class DataProvider
    {
        ...
        public static DataProvider Instance()
        {
            if (provider == null)
            {
                const string assembly = "DotNetNuke.Modules.Ourspace_Utilities.Data.SqlDataprovider,Ourspace_Utilities";
