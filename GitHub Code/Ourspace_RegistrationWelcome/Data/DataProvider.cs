...
namespace DotNetNuke.Modules.Ourspace_RegistrationWelcome.Data
{
    ...
    public abstract class DataProvider
    {
        ...
        public static DataProvider Instance()
        {
            if (provider == null)
            {
                const string assembly = "DotNetNuke.Modules.Ourspace_RegistrationWelcome.Data.SqlDataprovider,Ourspace_RegistrationWelcome";
