...
namespace DotNetNuke.Modules.Ourspace_Scheduler.Data
{
    ...
    public abstract class DataProvider
    {
        ...
        public static DataProvider Instance()
        {
            if (provider == null)
            {
                const string assembly = "DotNetNuke.Modules.Ourspace_Scheduler.Data.SqlDataprovider,Ourspace_Scheduler";
