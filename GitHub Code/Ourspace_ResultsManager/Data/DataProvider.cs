...
namespace DotNetNuke.Modules.Ourspace_ResultsManager.Data
{
    ...
    public abstract class DataProvider
    {
        ...
        public static DataProvider Instance()
        {
            if (provider == null)
            {
                const string assembly = "DotNetNuke.Modules.Ourspace_ResultsManager.Data.SqlDataprovider,Ourspace_ResultsManager";
