...
namespace DotNetNuke.Modules.Ourspace_SearchBox.Data
{
    ...
    public abstract class DataProvider
    {
        ...
        public static DataProvider Instance()
        {
            if (provider == null)
            {
                const string assembly = "DotNetNuke.Modules.Ourspace_SearchBox.Data.SqlDataprovider,Ourspace_SearchBox";
