...
namespace DotNetNuke.Modules.Ourspace_LocaleOverwriter.Data
{
    ...
    public abstract class DataProvider
    {
        ...
        public static DataProvider Instance()
        {
            if (provider == null)
            {
                const string assembly = "DotNetNuke.Modules.Ourspace_LocaleOverwriter.Data.SqlDataprovider,Ourspace_LocaleOverwriter";
