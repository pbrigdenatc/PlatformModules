...
namespace DotNetNuke.Modules.Ourspace_Dashboard.Data
{
    ...
    public abstract class DataProvider
    {
        ...
        public static DataProvider Instance()
        {
            if (provider == null)
            {
                const string assembly = "DotNetNuke.Modules.Ourspace_Dashboard.Data.SqlDataprovider,Ourspace_Dashboard";
