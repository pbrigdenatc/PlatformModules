...
namespace DotNetNuke.Modules.Ourspace_YourToolkit.Data
{
    ...
    public abstract class DataProvider
    {
        ...
        public static DataProvider Instance()
        {
            if (provider == null)
            {
                const string assembly = "DotNetNuke.Modules.Ourspace_YourToolkit.Data.SqlDataprovider,Ourspace_YourToolkit";
