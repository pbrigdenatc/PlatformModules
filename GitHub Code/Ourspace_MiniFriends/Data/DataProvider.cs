...
namespace DotNetNuke.Modules.Ourspace_MiniFriends.Data
{
    ...
    public abstract class DataProvider
    {
        ...
        public static DataProvider Instance()
        {
            if (provider == null)
            {
                const string assembly = "DotNetNuke.Modules.Ourspace_MiniFriends.Data.SqlDataprovider,Ourspace_MiniFriends";
