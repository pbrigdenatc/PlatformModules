...
namespace DotNetNuke.Modules.Ourspace_WhoIsOnOurspace.Data
{
    ...
    public abstract class DataProvider
    {
        ...
        public static DataProvider Instance()
        {
            if (provider == null)
            {
                const string assembly = "DotNetNuke.Modules.Ourspace_WhoIsOnOurspace.Data.SqlDataprovider,Ourspace_WhoIsOnOurspace";
