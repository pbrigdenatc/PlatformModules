...
namespace DotNetNuke.Modules.OurspaceNotifications.Data
{
    ...
    public abstract class DataProvider
    {
        ...
        public static DataProvider Instance()
        {
            if (provider == null)
            {
                const string assembly = "DotNetNuke.Modules.OurspaceNotifications.Data.SqlDataprovider,OurspaceNotifications";
