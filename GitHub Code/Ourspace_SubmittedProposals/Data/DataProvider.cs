...
namespace DotNetNuke.Modules.Ourspace_SubmittedProposals.Data
{
    ...
    public abstract class DataProvider
    {
        ...
        public static DataProvider Instance()
        {
            if (provider == null)
            {
                const string assembly = "DotNetNuke.Modules.Ourspace_SubmittedProposals.Data.SqlDataprovider,Ourspace_SubmittedProposals";
