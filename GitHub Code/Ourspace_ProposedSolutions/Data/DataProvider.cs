...
namespace DotNetNuke.Modules.Ourspace_ProposedSolutions.Data
{
    ...
    public abstract class DataProvider
    {
        ...
        public static DataProvider Instance()
        {
            if (provider == null)
            {
                const string assembly = "DotNetNuke.Modules.Ourspace_ProposedSolutions.Data.SqlDataprovider,Ourspace_ProposedSolutions";
