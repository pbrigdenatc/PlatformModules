...
namespace DotNetNuke.Modules.Ourspace_TranslationWidget
{
    ...
    /// </summary>
    /// -----------------------------------------------------------------------------
    public partial class View : Ourspace_TranslationWidgetModuleBase, IActionable
    {
        ...
        private void Page_Load(object sender, System.EventArgs e)
        {
            try
            {
                ...
                if (Session["postReported"] != null)
                {
                    Session["postReported"] = null;
                    Page.ClientScript.RegisterClientScriptInclude(this.GetType(), "postReportedScript", (this.TemplateSourceDirectory + "/js/PopupManager.js"));
