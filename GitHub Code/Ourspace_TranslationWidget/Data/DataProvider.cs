...
namespace DotNetNuke.Modules.Ourspace_TranslationWidget.Data
{
    ...
    public abstract class DataProvider
    {
        ...
        public static DataProvider Instance()
        {
            if (provider == null)
            {
                const string assembly = "DotNetNuke.Modules.Ourspace_TranslationWidget.Data.SqlDataprovider,Ourspace_TranslationWidget";
