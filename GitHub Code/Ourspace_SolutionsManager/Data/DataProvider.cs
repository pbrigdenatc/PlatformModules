...
namespace DotNetNuke.Modules.Ourspace_SolutionsManager.Data
{
    ...
    public abstract class DataProvider
    {
        ...
        public static DataProvider Instance()
        {
            if (provider == null)
            {
                const string assembly = "DotNetNuke.Modules.Ourspace_SolutionsManager.Data.SqlDataprovider,Ourspace_SolutionsManager";
