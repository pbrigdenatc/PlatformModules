...
namespace DotNetNuke.Modules.Ourspace_TextEditor.Data
{
    ...
    public abstract class DataProvider
    {
        ...
        public static DataProvider Instance()
        {
            if (provider == null)
            {
                const string assembly = "DotNetNuke.Modules.Ourspace_TextEditor.Data.SqlDataprovider,Ourspace_TextEditor";
