...
<div class="Post-Report">
	<table class="Forum_SearchContainer" id="tblMain" cellspacing="0" cellpadding="0" width="100%" align="center" >
			...
			<td align="left" colspan="2">
				<table cellspacing="0" cellpadding="0" border="0" width="100%">
					<tr>
						...
						<td class="Forum_Header" width="100%"><asp:label id="lblSubject" runat="server" CssClass="Forum_HeaderText hidden-title-override" /></td>
		...
		<tr>
			<td class="Forum_Row_Admin_Foot" align="right" colspan="2">
				<asp:linkbutton cssclass="action-button fright" id="cmdReport" runat="server" resourcekey="cmdReport" />
			<asp:linkbutton cssclass="action-button-dull fright" style="margin-right:15px;" id="cmdCancel" runat="server" resourcekey="cmdCancel" CausesValidation="False" />&nbsp;
				</td>
		</tr>
				<tr>
