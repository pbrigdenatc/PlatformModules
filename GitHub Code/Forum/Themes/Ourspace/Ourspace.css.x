...
.Forum_Container, .Forum_Container th, .Forum_Container td, .Forum_Container div, .Forum_Container p, .Forum_Container table, .Forum_Container a{font-family:Verdana, Arial, San-Serif;line-height:16px;}
...
.Forum_UCP_Header{background: url('images/header_bg.jpg') top left repeat-x;font-weight:bold;font-size:14px;color:#fff;font-family:"Lucida Grande", Helvetica, Arial, San-Serif;line-height:26px;}
...
.Forum_UCP_Item{padding: 2px 0px 2px 0px;}
	.Forum_UCP_Item a.Forum_Link, .Forum_UCP_Item a.Forum_Link:link, .Forum_UCP_Item a.Forum_Link:visited{color:#0088CE;text-transform:capitalize;font-size:12px;}
...
a.Forum_BreadCrumb:link, a.Forum_BreadCrumb:visited, a.Forum_BreadCrumb:active, a.Forum_BreadCrumb:hover{font: bold 11px "Lucida Grande", Helvetica, Arial, San-Serif;color:#0088CE;padding:10px 0px;display:block;}
A.Forum_BreadCrumb:hover{color:#006396;}
.Forum_BreadCrumb_Top_Wrapper{border-bottom: #000 1px dotted; height:30px;}
/*/////////////////////////// - FORUM VIEW - HEADER \\\\\\\\\\\\\\\\\\\\\\\\\\\*/
...
div.Forum_HeaderText, div a.Forum_HeaderText:Link, div a.Forum_HeaderText:visited, div a.Forum_HeaderText:active, div a.Forum_HeaderText:hover{font: normal bold 10px  Verdana, Arial, San-Serif;color:#000;/*text-transform:uppercase;*/}											
...
.Forum_AltHeaderCapLeft{width:1px;background: url("../../../../Portals/_Default/Skins/Ourspace/images/thread-header-bg.png")/*url('images/alt_header_bg.png')*/ top left repeat-x;border-top:solid 1px #fff;}
/* Handles initial view, groups, left area next to +/- and stats headers (right) */
.Forum_AltHeaderCapRight{width: 1px;background: url("../../../../Portals/_Default/Skins/Ourspace/images/thread-header-bg.png")/*url('images/alt_header_bg.png')*/ top left repeat-x;border-top: solid 1px #fff;}
/* Handles Group name hearder section, statistics header section  also header in whats new scroller */
.Forum_AltHeader{background: url("../../../../Portals/_Default/Skins/Ourspace/images/thread-header-bg.png")/*url('images/alt_header_bg.png')*/ top left repeat-x;border-top: solid 1px #fff;padding-left:8px;}
.Forum_AltHeader a, .Forum_AltHeader a:link, .Forum_AltHeader a:visited, .Forum_AltHeader a:hover, .Forum_AltHeader a:visited:hover{/*color:#006396;*/}
/* Forum Groups.  Overrides most section head controls.  Text for Forum Settings, User Settings */
.Forum_AltHeaderText, A.Forum_AltHeaderText:Link, A.Forum_AltHeaderText:Visited, A.Forum_AltHeaderText:Active{font:normal bold 14px Verdana, Helvetica, Arial, San-Serif;color:/*#0088CE*/#fff; text-decoration:none;}
...
.Forum_Footer{height:46px;/*background: url('images/footer_bg.jpg') top left repeat-x;border-top: #000 1px dotted;*/padding: 0 5px;}
/* These cap classes handle the left and rigt of colums (only in /forum admin header area)*/
...
td.Forum_FooterText a.Forum_FooterText, td.Forum_FooterText .Forum_FooterDisabled, div.Forum_FooterText a[href].Forum_FooterText, div.Forum_FooterText a.Forum_FooterText, div.Forum_FooterText .Forum_FooterDisabled{background:#fff;padding:2px 5px;color:#0088CE;display:inline-block;text-decoration:none;-moz-border-radius:2px;-webkit-border-radius:2px;font-size:9px !important;}
	...
	td.Forum_FooterText a.Forum_FooterText:hover, td.Forum_FooterText .Forum_FooterDisabled, div.Forum_FooterText a.Forum_FooterText:hover, div.Forum_FooterText .Forum_FooterDisabled, div.Forum_FooterText a.Forum_FooterText{background:/*#4D6880*/#5FB7FF;text-decoration:none;color:#fff;}
...
.Forum_Row, .Forum_Row_Alt{border-top:solid 1px #B8D7F3;border-bottom:solid 1px #B8D7F3;border-left:solid 1px #B8D7F3;background-color:#E8E8E8;padding:10px 5px 10px 10px;}
...
.Forum_RowHighlight1{border-left: solid 1px #B8D7F3;border-top:solid 1px #B8D7F3;border-bottom: solid 1px #B8D7F3;background-color: #E8E8E8;}							
/* Threads Column in initial group view (odd numbered)*/
.Forum_RowHighlight1_Alt{border-top: solid 1px #B8D7F3;border-bottom:solid 1px #B8D7F3;border-left: solid 1px #B8D7F3;background-color: #fff;}
/* Posts Column in initial group view */
.Forum_RowHighlight2{border-top: solid 1px #B8D7F3;border-bottom:solid 1px #B8D7F3;border-left: solid 1px #B8D7F3;background-color: #E8E8E8;}
/* Posts Column in initial group view (odd)*/
.Forum_RowHighlight2_Alt{border-top: solid 1px #B8D7F3; border-bottom:solid 1px #B8D7F3;border-left: solid 1px #B8D7F3;background-color: #fff;}
/* Last Post Column */
.Forum_RowHighlight3, .Forum_RowHighlight3_Alt{border:solid 1px #B8D7F3;background-color:#E8E8E8;}
...
.Forum_Avatar_Alt{padding:5px; padding-bottom:15px; padding-top:0;/*border:#B8D7F3 1px solid;border-bottom:none;*/background:#fff;}
.Forum_Avatar_Alt_First{padding:5px; padding-bottom:15px; padding-top:15px;/*border:#B8D7F3 1px solid;border-bottom:none;*/background:#fff;}

/* Area in eqach post where subject is - (top part) (ODD numbered rows) */
.Forum_PostDetails_Alt{padding:5px; padding-left:0;/*border-top:#B8D7F3 1px solid;background:#eee;*/}
...
.Forum_PostBody_Alt{padding:15px; padding-left:0; padding-top:0; padding-bottom:0;}
/* Post View avatar area (EVEN numbered rows) */
.Forum_Avatar{padding:5px; padding-bottom:15px; padding-top:0;/*border:#B8D7F3 1px solid;border-right:none;border-bottom:none;*/background:#fff;}
...
td.Forum_UserAvatar img{border:1px #ccc solid; width:70px; margin-top:10px;-moz-border-radius:5px;-webkit-border-radius:5px;padding:4px;background:#fff;}
/* Post content area (this is post details, post buttons, post body, attachments containing cell) */
.Forum_PostBody_Container{padding-bottom:16px;/*border-left:#B8D7F3 1px solid;border-right:1px solid #B8D7F3*/}
.Forum_PostBody_Container_Alt{ padding-bottom:20px;/*border-right:#B8D7F3 1px solid;*/}

.Forum_PostBody_Container_First{ padding-bottom:20px; padding-top:15px;/*border-right:#B8D7F3 1px solid;*/}
.Forum_PostBody_Container_Alt_First{ padding-bottom:20px; padding-top:15px;/*border-right:#B8D7F3 1px solid;*/}
...
.Forum_PostBody{padding:15px;padding-left:0; padding-top:0;}
...
.Forum_SpacerRow{/*border-top: #000 1px dotted;*/ height:20px;}
.Forum_ReportCell{width:300px;}
/*/////////////////////////// = SPLIT-THREAD VIEW = \\\\\\\\\\\\\\\\\\\\\\\\\\\*/
...
.Forum_PostDate{color:#545454; font-weight:normal; font-size:11px; margin-bottom:5px;}
...
.Forum_Row_AdminL{/*border-top: #B8D7F3 1px solid;border-left: #B8D7F3 1px solid;*/padding-left: 4px;/*background-color: #F7F7F7;*/font-size: 7pt;color: #666;font-family: Helvetica, Arial, San-Serif;}
.Forum_Row_AdminM{border-top: #B8D7F3 1px solid;padding-left: 4px;background-color: #F7F7F7;font-size: 10px;color: #666;font-family: Helvetica, Arial, San-Serif;}
...
.Forum_Admin_SectionHead{font-family: normal bold Helvetica, Arial, sans-serif;font-size:12px;color: #999;font-variant:small-caps;border-left: #B8D7F3 0px solid;border-right: #B8D7F3 0px solid;border-top: #B8D7F3 1px solid;background: url('Images/text-bg.jpg') repeat-x;}
...
.Forum_Attachments, .Forum_Attachments_Alt{border:1px solid #bbb;background-color:#eee;padding:3px 5px;}
/* Attachment area at bottom of post view.  Each attacment is own row - Alternate*/
.Forum_Attachments_Alt{background-color:/*#DEDEDE*/#d6ecff;}
/* TextBoxes (This is only for the lookup control created by module) NEED FONT HERE*/
.Forum_ListCell{font: normal normal 10px Helvetica, Arial, San-Serif;border: 1px solid #B8D7F3;background-color: White;}
...
a.Forum_NormalSmall:link, a.Forum_NormalSmall:visited, a.Forum_NormalSmall:active, a.Forum_NormalSmall:hover{font: 11px Helvetica, Arial, San-Serif;color:#0088ce;}
...
.Forum_GroupDetails{font-size:11px;font-family:Helvetica, Arial, San-Serif;display:block;padding:5px 0;line-height:14px;}
	.Forum_GroupDetails a, .Forum_GroupDetails a:link, .Forum_GroupDetails a:active, .Forum_GroupDetails a:visited{font-size:11px;font-family:Helvetica, Arial, San-Serif;color:#0088ce;text-decoration:none;}
...
td.Forum_LastPostText a.Forum_LastPostText{background:#5fb7ff;padding:2px 6px;color:#fff;display:inline-block;text-decoration:none;-moz-border-radius:3px;-webkit-border-radius:3px;border-bottom:1px solid #5C7992;border-right:1px solid #5C7992;}
	td.Forum_LastPostText a.Forum_LastPostText:hover{background:#59a8e9;text-decoration:none;border-bottom:1px solid #4D657A;border-right:1px solid #4D657A;}
/* Links used in style above areas */
...
td.Forum_ReplyCell a.Forum_Link{display:block;padding:4px 8px;background:#5fb7ff;color:#fff;/*border-bottom:1px solid #5C7992;border-right:1px solid #5C7992;*/-moz-border-radius:6px;-webkit-border-radius:6px;border-radius: 6px 6px 6px 6px;text-transform:capitalize;}
	td.Forum_ReplyCell a.Forum_Link:hover{background:#59a8e9;color:#fff;/*border-bottom:1px solid #4D657A;border-right:1px solid #4D657A;*/-moz-border-radius:6px;-webkit-border-radius:6px;text-transform:capitalize;}
...
.Forum_Link, A.Forum_Link:Link, A.Forum_Link:Visited, TD.Active, A.Forum_Link:Hover {font: bold 10px Helvetica, Arial, San-Serif;color: #ffc30d;text-align: center;text-decoration: none;}
A.Forum_Link:Hover{color: #c60001;text-decoration: none;}
/* Only seen if option is disabled to show icons for toolbar */
TD.Active{} 
.Forum_ToolbarLink, a.Forum_ToolbarLink:link, a.Forum_ToolbarLink:visited, a.Forum_ToolbarLink:hover{text-decoration: none;font-family: Helvetica, Arial, San-Serif;display:block;float:left;padding:5px 8px;background:#5fb7ff;color:#fff;/*border-bottom:1px solid #5C7992;border-right:1px solid #5C7992;*/-moz-border-radius:6px;-webkit-border-radius:6px;margin:0 2px;font-weight:bold;}
a.Forum_ToolbarLink:hover{background:#59a8e9;color:#fff;/*border-bottom:1px solid #4D657A;border-right:1px solid #4D657A;*/-moz-border-radius:6px;-webkit-border-radius:6px;text-decoration:none;}
/*Profile link, used above posts avatar area (user alias) */
.Forum_Profile, a.Forum_Profile:link, a.Forum_Profile:visited, a.Forum_Profile:active, a.Forum_Profile:hover{font-family:Helvetica, Arial, San-Serif;font-size:11px;color:#0088CE;font-weight:bold;}
a.Forum_Profile:hover{color:#006396;}
.Forum_Tab_Left{color:#0088CE;padding:4px;}
a.Forum_Link:hover, a.Forum_Link_Left:hover,{color:#006396;text-decoration:underline;font-size:12px;}
.Forum_Link, a.Forum_Link:link, a.Forum_Link:visited, .Forum_Link_Left, a.Forum_Link_Left:link, a.Forum_Link_Left:visited{color:#0088CE;font-size:12px;}
...
.Forum_NavBarButton A.Forum_Link:Link, .Forum_NavBarButton A.Forum_Link:Visited, .Forum_NavBarButton A.Forum_Link:Active, .Forum_NavBarButton A.Forum_Link_Left:Link, .Forum_NavBarButton A.Forum_Link_Left:Visited, .Forum_NavBarButton A.Forum_Link_Left:Active{font: normal bold 12px Helvetica, Arial, San-Serif;text-align:center;text-decoration:none;color:#fff;}
...
td.Forum_NavBarButton a.Forum_Link{background: url('images/button-arrow.png') top right no-repeat;font: normal bold 12px Helvetica, Arial, San-Serif; background-position: 94% 55%; display:block;background-color:#5fb7ff;color:#fff;/*border-bottom:1px solid #5C7992;border-right:1px solid #5C7992;*/-moz-border-radius:6px;-webkit-border-radius:6px; border-radius: 6px 6px 6px 6px;text-transform:capitalize;padding:5px 8px; padding-right:17px;}
td.Forum_NavBarButton a.Forum_Link_Left{background: url('images/button-arrow-left.png') top right no-repeat; background-position: 8% 54%; display:block;background-color:#5fb7ff;color:#fff;-moz-border-radius:6px;-webkit-border-radius:6px; border-radius: 6px 6px 6px 6px; text-transform:capitalize;padding:5px 8px; padding-left:17px;}
a.Forum_Link_Arrow{background: url('images/button-arrow.png') top right no-repeat;font: normal bold 12px Helvetica, Arial, San-Serif !important; background-position: 94% 55%; display:block;background-color:#5fb7ff;color:#fff !important; text-decoration:none !important; text-align:center;/*border-bottom:1px solid #5C7992;border-right:1px solid #5C7992;*/-moz-border-radius:6px;-webkit-border-radius:6px; border-radius: 6px 6px 6px 6px;text-transform:capitalize;padding:5px 8px; padding-right:17px;}

	td.Forum_NavBarButton a.Forum_Link:hover,a.Forum_Link_Arrow:hover, td.Forum_NavBarButton a.Forum_Link_Left:hover{background-color:#59a8e9;color:#fff; font-size:12px;/*border-bottom:1px solid #4D657A;border-right:1px solid #4D657A;*/-moz-border-radius:6px;-webkit-border-radius:6px;text-decoration:none;text-transform:capitalize; font:normal bold 12px Helvetica, Arial, San-Serif; }
...
.Forum_Grid_Header{background: url('Images/header_bg.jpg') repeat;height: 41px;font-weight: bold;font-size: 11px;font-family: Helvetica, Arial, San-Serif; text-transform: uppercase; color: white;}
...
.PagerContainerTable{border-top: #B8D7F3 1px solid;width: 100%;background: url(images/pb_footer_bg.jpg) top left repeat-x;	height:26px;font-size: 11px;font-family: Helvetica, Arial, San-Serif;}
...
/*Forum Search */
.Forum_SearchContainer .Forum_Row_AdminText{font-size:12px;font-weight:bold;text-align:right;display:block; float:left;padding-right:15px;}
.Forum_SearchContainer .Forum_Row_AdminText span { display: inline; }
...
.Forum_Container .tags li a{font-size: 11px;font-family: Helvetica, Arial, San-Serif;color:#0088CE; font-weight: bold;}
.Forum_Container .tags li a:hover{color:#006396;}
.AdvertisementPost {border: thin solid #BDBDBD;padding: 10px;}
.Forum_PostAuthorTable .Forum_NormalSmall {font-size:10px; color: #888;}
.author-name{font-size:13px; font-weight:bold;}
.thread-phases-container
{
	background-image: url(../../../../Portals/_Default/Skins/Ourspace/images/phase-arrow.png);
...
.phase-progress-text-active
{
	color: #ff9900;
	
}

.phase-progress-text-inactive
{
	color: #999;
}

.phase-progress-text-complete
{
	color: #ff9900;
}

.phase-progress-1-active
{
	background-image: url(../../../../Portals/_Default/Skins/Ourspace/images/phase-1-active.png);
}

.phase-progress-2-active
{
	background-image: url(../../../../Portals/_Default/Skins/Ourspace/images/phase-2-active.png);
}

.phase-progress-3-active
{
	background-image: url(../../../../Portals/_Default/Skins/Ourspace/images/phase-3-active.png);
}

.phase-progress-4-active
{
	background-image: url(../../../../Portals/_Default/Skins/Ourspace/images/phase-4-active.png);
}

.phase-progress-5-active
{
	background-image: url(../../../../Portals/_Default/Skins/Ourspace/images/phase-5-active.png);
}

.phase-progress-1-complete
{
	background-image: url(../../../../Portals/_Default/Skins/Ourspace/images/phase-1-complete.png);
}

.phase-progress-2-complete
{
	background-image: url(../../../../Portals/_Default/Skins/Ourspace/images/phase-2-complete.png);
}

.phase-progress-3-complete
{
	background-image: url(../../../../Portals/_Default/Skins/Ourspace/images/phase-3-complete.png);
}

.phase-progress-4-complete
{
	background-image: url(../../../../Portals/_Default/Skins/Ourspace/images/phase-4-complete.png);
}

.phase-progress-5-complete
{
	background-image: url(../../../../Portals/_Default/Skins/Ourspace/images/phase-5-complete.png);
}

.phase-progress-1-inactive
{
	background-image: url(../../../../Portals/_Default/Skins/Ourspace/images/phase-1-inactive.png);
}

.phase-progress-2-inactive
{
	background-image: url(../../../../Portals/_Default/Skins/Ourspace/images/phase-2-inactive.png);
}

.phase-progress-3-inactive
{
	background-image: url(../../../../Portals/_Default/Skins/Ourspace/images/phase-3-inactive.png);
}

.phase-progress-4-inactive
{
	background-image: url(../../../../Portals/_Default/Skins/Ourspace/images/phase-4-inactive.png);
}

.phase-progress-5-inactive
{
	background-image: url(../../../../Portals/_Default/Skins/Ourspace/images/phase-5-inactive.png);
}
.thread-header
{
background-image: url('../../../../Portals/_Default/Skins/Ourspace/images/thread-header-bg.png');
height:33px;
color:#fff;
font-size:14px;
padding-left:15px;
...
.thread-info-container a
{
	color: #000 !important;
	text-decoration:none !important;
}

.thread-info-container a:hover
{
...
.thread-black-link:hover
{
	color: #000 !important;
	text-decoration:underline !important;
}

.Forum_Avatar, .Forum_PostBody_Container, .Forum_Avatar_Alt, .Forum_PostBody_Container_Alt, .Forum_PostBody_Container_Alt_First, .Forum_Avatar_Alt_First, .Forum_Avatar_First
{
	border-bottom: 1px dotted #000;
}
...
.poll-vote-percentage-container
{
	width:100px;
}

.poll-bar-image-container img
{
	margin-top:2px;
}