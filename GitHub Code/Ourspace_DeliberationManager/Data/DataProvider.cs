...
namespace DotNetNuke.Modules.Ourspace_DeliberationManager.Data
{
    ...
    public abstract class DataProvider
    {
        ...
        public static DataProvider Instance()
        {
            if (provider == null)
            {
                const string assembly = "DotNetNuke.Modules.Ourspace_DeliberationManager.Data.SqlDataprovider,Ourspace_DeliberationManager";
