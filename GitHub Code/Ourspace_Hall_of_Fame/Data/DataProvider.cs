...
namespace DotNetNuke.Modules.Ourspace_Hall_of_Fame.Data
{
    ...
    public abstract class DataProvider
    {
        ...
        public static DataProvider Instance()
        {
            if (provider == null)
            {
                const string assembly = "DotNetNuke.Modules.Ourspace_Hall_of_Fame.Data.SqlDataprovider,Ourspace_Hall_of_Fame";
